...
>
> **Scope:** Template repo `workflow-orchestration-queue-november57-b` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
